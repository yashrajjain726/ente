...
- View all quick links in the Albums tab under "Quick links" (tap the 'v' icon at the right)
...
- To see quick links, open the Albums tab, tap on 'v' icon at the right, then tap "Quick links"
