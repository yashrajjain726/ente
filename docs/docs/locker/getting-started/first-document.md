...
5. Select **Uncategorized**, or select one or more collections to organize this item
6. Tap **Save**
...
4. Select **Uncategorized**, or select one or more collections to organize this item
5. Tap **Save**
...
2. Select **Uncategorized**, select one or more existing collections, or create a new one
3. Your item will be saved to those collections

Use Uncategorized when you want to save an item now and organize it into your own collections later.
