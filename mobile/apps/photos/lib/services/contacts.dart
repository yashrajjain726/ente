...
import 'package:photos/src/rust/third_party/ente_frb_lib/contacts.dart'
    as contacts;
import 'package:photos/src/rust/third_party/ente_frb_lib/session.dart';

class PhotosContactsApi implements ContactsApi {
  const PhotosContactsApi(this._session);
