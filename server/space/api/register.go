...
func Register(privateAPI, publicAPI gin.IRouter, handlers *Handlers) {
	...
	spaceAPI.PUT("/posts/:postID/like", handlers.LikePost)
	spaceAPI.DELETE("/posts/:postID/like", handlers.UnlikePost)
	...
	spaceAPI.POST("/friends/:friendSpaceID/read", handlers.MarkNotificationsRead)
	spaceAPI.GET("/friends/:friendSpaceID/messages", handlers.ListMessageThread)
	spaceAPI.POST("/friends/:friendSpaceID/messages", handlers.CreateMessage)
	spaceAPI.PUT("/messages/:messageID/like", handlers.LikeMessage)
	spaceAPI.DELETE("/messages/:messageID/like", handlers.UnlikeMessage)
	spaceAPI.DELETE("/messages/:messageID", handlers.DeleteMessage)
