...
pub use client::{
    ...
    MAX_WALL_MESSAGE_CIPHER_DECODED_BYTES, MAX_WALL_MESSAGE_PAYLOAD_BYTES,
    MAX_WALL_MESSAGE_TEXT_BYTES, MAX_WALL_MESSAGE_TEXT_CHARS, MAX_WALL_POST_PLAINTEXT_BYTES,
    MAX_WALL_POST_UPLOAD_BYTES, WallLinkCtx,
};
