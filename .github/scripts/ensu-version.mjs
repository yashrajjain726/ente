...
const files = {
    ...
    android: path.join(root, "android/apps/ensu/app/build.gradle.kts"),
    xcode: path.join(root, "apple/apps/ensu/Ensu.xcodeproj/project.pbxproj"),
    plist: path.join(root, "apple/apps/ensu/Ensu/Info.plist"),
};
