...
const CheckboxMark = styled("span")({
    ...
    "input:disabled + &": {
        backgroundColor: "var(--photos-auth-text-disabled)",
    },
    "input:not(:checked) + &": {
        backgroundColor: "transparent",
        boxShadow: "inset 0 0 0 1px var(--photos-auth-text-faint)",
    },
    "input:not(:checked):disabled + &": {
        boxShadow: "inset 0 0 0 1px var(--photos-auth-text-disabled)",
    },
