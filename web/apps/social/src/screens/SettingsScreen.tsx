...
const SettingsRow: React.FC<SettingsRowProps> = ({ danger, icon, label }) => (
    <Box
        component="button"
        type="button"
        sx={{
...
export const SettingsScreen: React.FC<SettingsScreenProps> = ({
    ...
    const accountLabel = email.trim() || `${profile.username}@ente.io`;
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <SettingsRow danger icon={Logout05Icon} label="Logout" />
                </Box>
