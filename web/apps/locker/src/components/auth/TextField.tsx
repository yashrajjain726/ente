...
const FieldRoot = styled("div")({
    "--locker-auth-message-gap": "9px",
    width: "100%",
    display: "flex",
    flexDirection: "column",
    gap: "9px",
    "&:focus-within > label": { color: "var(--locker-auth-text)" },
});
...
const RequiredMark = styled("span")({ color: "var(--locker-auth-warning)" });
...
const FieldBox = styled(
    ...
    backgroundColor: $disabled
        ? "var(--locker-auth-fill-hover)"
        : "var(--locker-auth-field)",
    boxShadow: $disabled
        ? "none"
        : `inset 0 0 0 1px ${
              $error
                  ? "var(--locker-auth-warning)"
                  : "var(--locker-auth-stroke)"
          }`,
...
const controlStyles = {
    ...
    "&::placeholder": { color: "var(--locker-auth-text-faint)", opacity: 1 },
    "&:disabled": {
        color: "var(--locker-auth-text-disabled)",
        WebkitTextFillColor: "var(--locker-auth-text-disabled)",
        cursor: "not-allowed",
    },
};
