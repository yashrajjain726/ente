// PhotoSwipe requires raw SVG markup; named entries came from the matching MUI icons.
// Transforms are local alignment adjustments, not part of the MUI paths.
const paths = {
