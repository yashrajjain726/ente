...
final class EnsuLogging: Sendable {
    ...
    func start() {
        ...
        isStarted = true
        queue.async { self.pruneOldLogFiles() }
        log(level: .info, tag: "App", message: buildAppLaunchMessage())
...
private final class EnsuRustLogSink: RustLogSink {
